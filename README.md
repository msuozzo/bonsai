...
> Note: Regeneration builds [`ncruces/wasm2go`](https://github.com/ncruces/wasm2go)
> pinned by commit in `Dockerfile.builder`: the pass that keeps large lexers
> within go/parser's nesting limits ([ncruces/wasm2go#42](https://github.com/ncruces/wasm2go/pull/42))
> landed after the latest tagged release. The pin moves to a tagged release
> once one contains it.
