// Package bonsaikotlin provides a tree-sitter Kotlin parser built on the
...
// the repo root. `go generate ./bonsai-kotlin` regenerates module_gen.{go,dat},
// libc_gen.go, and meta_gen.go in this directory.
//
// Grammar source: https://github.com/tree-sitter-grammars/tree-sitter-kotlin
