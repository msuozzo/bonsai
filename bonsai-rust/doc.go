// Package bonsairust provides a tree-sitter Rust parser built on the
...
// the repo root. `go generate ./bonsai-rust` regenerates module_gen.{go,dat},
// libc_gen.go, and meta_gen.go in this directory.
//
// Grammar source: https://github.com/tree-sitter/tree-sitter-rust
package bonsairust
